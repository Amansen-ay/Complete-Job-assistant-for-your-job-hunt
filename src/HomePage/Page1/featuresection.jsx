...
const features = [
  ...
  },
  {
    ...
    desc: "Compare application success across different job portals and discover where your best opportunities come from.",
  },
  {
    icon: "💼",
    iconBg: "#e8fbf3",
    title: "Application Workspace",
    desc: "Keep every application organized with notes, custom tags, reminders, and detailed progress tracking in one place.",
  },
  {
    icon: "🎯",
    iconBg: "#ede9fb",
    title: "Weekly Goal Tracker",
    desc: "Stay consistent by tracking your weekly application target and monitor your progress toward your job search goals.",
  },
  {
    icon: "⏰",
    iconBg: "#fdecea",
