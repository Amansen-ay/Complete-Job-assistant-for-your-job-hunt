...
export default function Calender() {
    ...
    function deleteOneEvent(eventToDelete) {
        ...
        <div className="instruction">
         ...
         <div className="modalBtns">
            ...
            onClick={() => {
               ...
               eventTitle.trim()!=="" &&  eventRole.trim()!=="" && 
      ...
      <div className="eventModal">
         ...
         <div className="all-events-list-container">
         {
            ...
            <div
               ...
               <div className="event-row-right-section">
                   <svg 
                       className="individual-delete-btn-svg" 
                       onClick={() => deleteOneEvent(event)}
                       viewBox="0 0 24 24" 
                       fill="none" 
                       stroke="currentColor" 
                       strokeWidth="2" 
